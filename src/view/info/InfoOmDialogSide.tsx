    ...
    return (
        <div className={styles.side}>
            <div className={styles.seksjon}>
                <Innholdstittel>Hva er dialogen?</Innholdstittel>
                <Normaltekst>
            ...
            <div className={styles.seksjon}>
                ...
                <Normaltekst>
                    Vi svarer i løpet av noen dager. Haster det, eller du ikke får svar, kontakt oss på telefon 55 55 33
                    33.
                </Normaltekst>
            </div>
            ...
            <div className={styles.seksjon}>
                ...
                <Normaltekst>
                    Du skal bare skrive om det som handler om å komme i jobb. Du kan ikke stille spørsmål om økonomi
                    eller boligsituasjonen din.
                </Normaltekst>
