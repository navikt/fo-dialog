    ...
    return (
        <div>
            <div className="oppfolging-alertstripe">
                <OppfolgingAlertStripeVisibleProp visible={(!isUnderOppfolging && !hasOppfolgingsPerioder && !erVeileder)}>
                    Du må være registrert hos NAV for å bruke aktivitetsplanen.
                </OppfolgingAlertStripeVisibleProp>
            </div>
            <div className="oppfolging-alertstripe">
                <OppfolgingAlertStripeVisibleProp visible={!isUnderOppfolging && !erVeileder}>
                    <Normaltekst>
