  ...
  return (
    <>
      ...
      <AlertStripe
        ...
        visible={!erUnderOppfolging && harOppfolgingsPerioder && !erVeileder}
      >
        Du er ikke lenger registrert hos NAV og din tidligere aktivitetsplan er
        lagt under "Mine tidligere planer". Hvis du fortsatt skal motta ytelser,
        få oppfølging fra NAV og bruke aktivitetsplanen må du være registrert.
