...
export function DialogPreview(props: Props) {
  const datoString = !!props.dialog.sisteDato
    ? formaterHenvendelseDate(props.dialog.sisteDato)
    : "";
    ...
    >
      ...
      <div className="dialog-preview__internal-div">
        ...
        <Systemtittel className="lenkepanel__heading">
          {" "}
          {props.dialog.overskrift}
        </Systemtittel>
        <Normaltekst className="dialog-preview__last-henvendelse">
          {props.dialog.sisteTekst}
        </Normaltekst>
